...
export default function Alert(props: alertMessage) {
  let txHash = props.message;

  return (
    <div
      className={`h-18 w-75 border-2 border-accent bg-white absolute top-[10vh] ${props.isActive ? "left-3/12 md:left-7/12 xl:left-9/12" : "left-12/12 "} flex z-10 p-2 rounded-xl  justify-between items-center text-text/90 transition-all ease-in-out duration-400`}
    >
      <div className="w-[20%] ">
